...
export default function AdminEditarCursoPage() {
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#f6f4f3", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center", padding: 40 }}>
          ...
          <a href="/cursos" style={{ display: "inline-block", marginTop: 16, fontSize: 14, fontWeight: 700, color: "#CC1F1F" }}>← Voltar para cursos</a>
        </div>
      </div>
    );
  }
