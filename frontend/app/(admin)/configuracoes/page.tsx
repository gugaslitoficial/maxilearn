...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h3 style={{ fontSize: 16, fontWeight: 800, color: "#16100f", marginBottom: 16, paddingBottom: 12, borderBottom: "1px solid #f4eded" }}>
      {children}
    </h3>
  );
}
...
export default function ConfiguracoesPage() {
  ...
  const [dados, setDados] = useState({
    company: "MaxiLearn Treinamentos",
    cnpj: "12.345.678/0001-90",
    segment: "Indústria",
    email: "contato@maxi1.com.br",
    phone: "(11) 99999-0000",
    site: "https://maxi1.com.br",
  });
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div style={{ gridColumn: "1/-1" }}>
                  ...
                  <input value={dados.company} onChange={(e) => setDados((d) => ({ ...d, company: e.target.value }))} style={inputStyle} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="email" value={dados.email} onChange={(e) => setDados((d) => ({ ...d, email: e.target.value }))} style={inputStyle} />
                </div>
                <div>
          ...
          {tab === "plano" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              <div
                style={{
                  borderRadius: 18,
                  background: "linear-gradient(135deg,#CC1F1F 0%,#a01515 100%)",
                  padding: "28px 30px",
                  color: "#fff",
                  position: "relative",
                  overflow: "hidden",
              ...
              >
                ...
                />
                <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: "0.1em", textTransform: "uppercase", opacity: 0.7, marginBottom: 8 }}>
                  Plano
                </div>
                <div style={{ fontSize: 32, fontWeight: 900, letterSpacing: "-0.03em", marginBottom: 4 }}>
                  Profissional
                </div>
                <div style={{ fontSize: 18, fontWeight: 800, opacity: 0.9, marginBottom: 20 }}>
                  R$ 799<span style={{ fontSize: 13, fontWeight: 600, opacity: 0.75 }}>/mês</span>
                </div>
                ...
                <div style={{ marginTop: 20, paddingTop: 16, borderTop: "1px solid rgba(255,255,255,0.2)", fontSize: 13.5, fontWeight: 700, opacity: 0.85 }}>
                  Renovação em{" "}
                  <span style={{ color: "#ffd6d6", fontWeight: 800 }}>14 de julho de 2026</span>
                </div>
              </div>
          ...
          {tab === "notificacoes" && (
            <div>
              ...
              <ToggleRow
                ...
                description="Receba um e-mail quando um novo usuário se cadastrar."
                checked={notifs.newUser}
                onChange={() => { setNotifs((n) => ({ ...n, newUser: !n.newUser })); setToast("Preferências atualizadas!"); }}
              />
              <ToggleRow
                label="Curso concluído"
                description="Seja notificado quando um aluno concluir um curso."
                checked={notifs.courseDone}
                onChange={() => { setNotifs((n) => ({ ...n, courseDone: !n.courseDone })); setToast("Preferências atualizadas!"); }}
              />
              <ToggleRow
                label="Alerta de inatividade"
                description="Receba alertas sobre usuários sem acesso há mais de 14 dias."
                checked={notifs.inactiveAlert}
                onChange={() => { setNotifs((n) => ({ ...n, inactiveAlert: !n.inactiveAlert })); setToast("Preferências atualizadas!"); }}
              />
            </div>
          )}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              <div>
                ...
                <ToggleRow
                  ...
                  onChange={() => { setSec((s) => ({ ...s, twoFactor: !s.twoFactor })); setToast("Configuração de segurança atualizada!"); }}
                />
              </div>
              <div>
                ...
                <ToggleRow
                  ...
                  checked={sec.strongPassword}
                  onChange={() => { setSec((s) => ({ ...s, strongPassword: !s.strongPassword })); setToast("Política de senha atualizada!"); }}
                />
              </div>
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 180 }}>
                    ...
                    <div style={{ fontSize: 13, fontWeight: 500, color: "#8a807e", marginTop: 2 }}>
                      Usuários serão desconectados após o tempo de inatividade definido.
                    </div>
                  </div>
                  <select
                    value={sec.sessionHours}
                    onChange={(e) => setSec((s) => ({ ...s, sessionHours: e.target.value }))}
