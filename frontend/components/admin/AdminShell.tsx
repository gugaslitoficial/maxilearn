...
import { LayoutDashboard, Users, BookOpen, BarChart3, Tag, Layers, Settings, ClipboardList, Inbox } from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { key: "solicitacoes", label: "Solicitações", href: "/solicitacoes", Icon: Inbox },
