// Dados mockados centralizados — substituir por chamadas reais de API na Etapa 4
...
export const MOCK_USERS: MockUser[] = [
  { id: "1", initials: "CM", name: "Carlos Mendes", email: "carlos@maxi1.com.br", role: "Admin", courses: "—", lastAccess: "Agora", status: "Ativo", avatarColor: "#CC1F1F" },
  { id: "2", initials: "RP", name: "Ricardo Paz", email: "ricardo@maxi1.com.br", role: "Professor", courses: "6", lastAccess: "há 2 horas", status: "Ativo", avatarColor: "#3a6ea5" },
  { id: "3", initials: "AL", name: "Ana Lima", email: "ana.lima@maxi1.com.br", role: "Estudante", courses: "4", lastAccess: "há 8 minutos", status: "Ativo", avatarColor: "#1f8a5b" },
  { id: "4", initials: "HD", name: "Helena Dias", email: "helena@maxi1.com.br", role: "Professor", courses: "9", lastAccess: "ontem", status: "Ativo", avatarColor: "#b9842f" },
  { id: "5", initials: "JS", name: "João Souza", email: "joao.souza@maxi1.com.br", role: "Estudante", courses: "3", lastAccess: "há 1 hora", status: "Ativo", avatarColor: "#7a4fb9" },
  { id: "6", initials: "MT", name: "Marina Teixeira", email: "marina.t@maxi1.com.br", role: "Estudante", courses: "2", lastAccess: "há 5 dias", status: "Inativo", avatarColor: "#c0573a" },
  { id: "7", initials: "BA", name: "Bruno Alves", email: "bruno@maxi1.com.br", role: "Professor", courses: "5", lastAccess: "há 3 horas", status: "Ativo", avatarColor: "#2f9b8e" },
  { id: "8", initials: "SN", name: "Sofia Nunes", email: "sofia.nunes@maxi1.com.br", role: "Estudante", courses: "7", lastAccess: "há 12 dias", status: "Inativo", avatarColor: "#9b2f7a" },
];

export const MOCK_COURSES: MockCourse[] = [
  { id: "1", tag: "ST", title: "Segurança no Trabalho", category: "Segurança", teacher: "Ricardo Paz", teacherInitials: "RP", teacherColor: "#3a6ea5", lessons: "12", students: "312", status: "Publicado", gradient: "linear-gradient(135deg,#CC1F1F,#e85a4f)" },
  { id: "2", tag: "LI", title: "Lubrificação Industrial", category: "Técnico", teacher: "Helena Dias", teacherInitials: "HD", teacherColor: "#b9842f", lessons: "18", students: "268", status: "Publicado", gradient: "linear-gradient(135deg,#3a6ea5,#5b9bd5)" },
  { id: "3", tag: "AC", title: "Atendimento ao Cliente", category: "Comportamental", teacher: "Bruno Alves", teacherInitials: "BA", teacherColor: "#2f9b8e", lessons: "9", students: "241", status: "Publicado", gradient: "linear-gradient(135deg,#1f8a5b,#43b787)" },
  { id: "4", tag: "LT", title: "Liderança de Times", category: "Comportamental", teacher: "Helena Dias", teacherInitials: "HD", teacherColor: "#b9842f", lessons: "14", students: "197", status: "Rascunho", gradient: "linear-gradient(135deg,#b9842f,#e0a94d)" },
  { id: "5", tag: "CL", title: "Compliance e LGPD", category: "Compliance", teacher: "Sofia Nunes", teacherInitials: "SN", teacherColor: "#9b2f7a", lessons: "7", students: "154", status: "Publicado", gradient: "linear-gradient(135deg,#7a4fb9,#a06fe0)" },
  { id: "6", tag: "GM", title: "Gestão de Manutenção", category: "Técnico", teacher: "Ricardo Paz", teacherInitials: "RP", teacherColor: "#3a6ea5", lessons: "11", students: "0", status: "Arquivado", gradient: "linear-gradient(135deg,#6a605e,#9a8f8c)" },
];

export const MOCK_ACTIVITIES: MockActivity[] = [
  { initials: "AL", text: 'Ana Lima concluiu o curso "Segurança no Trabalho"', time: "há 8 minutos", color: "#CC1F1F" },
  { initials: "RP", text: 'Prof. Ricardo Paz criou a aula "Lubrificação Industrial 02"', time: "há 34 minutos", color: "#3a6ea5" },
  { initials: "JS", text: 'João Souza obteve certificado em "Atendimento ao Cliente"', time: "há 1 hora", color: "#1f8a5b" },
  { initials: "MT", text: "Marina Teixeira foi adicionada à equipe Comercial", time: "há 2 horas", color: "#b9842f" },
  { initials: "CF", text: 'Carla Faria iniciou o curso "Liderança de Times"', time: "há 3 horas", color: "#7a4fb9" },
];

export const MOCK_TOP_COURSES = [
  { name: "Segurança no Trabalho", teacher: "Ricardo Paz", students: "312", pct: 94, tag: "ST", color: "#CC1F1F" },
  { name: "Lubrificação Industrial", teacher: "Helena Dias", students: "268", pct: 88, tag: "LI", color: "#3a6ea5" },
  { name: "Atendimento ao Cliente", teacher: "Bruno Alves", students: "241", pct: 82, tag: "AC", color: "#1f8a5b" },
  { name: "Liderança de Times", teacher: "Helena Dias", students: "197", pct: 76, tag: "LT", color: "#b9842f" },
  { name: "Compliance e LGPD", teacher: "Sofia Nunes", students: "154", pct: 69, tag: "CL", color: "#7a4fb9" },
];

export const MOCK_ENGAGEMENT_DATA = [
  { date: "22 mai", value: 380 },
  { date: "24 mai", value: 420 },
  { date: "26 mai", value: 390 },
  { date: "28 mai", value: 510 },
  { date: "30 mai", value: 480 },
  { date: "1 jun", value: 620 },
  { date: "3 jun", value: 590 },
  { date: "5 jun", value: 710 },
  { date: "7 jun", value: 680 },
  { date: "9 jun", value: 820 },
  { date: "11 jun", value: 780 },
  { date: "13 jun", value: 910 },
  { date: "15 jun", value: 870 },
  { date: "17 jun", value: 960 },
  { date: "20 jun", value: 1040 },
];

export const MOCK_REPORT_USERS = [
  { initials: "AL", name: "Ana Lima", started: 6, completed: 4, hours: "38h", certs: 4, color: "#1f8a5b" },
  { initials: "JS", name: "João Souza", started: 5, completed: 3, hours: "29h", certs: 3, color: "#7a4fb9" },
  { initials: "MT", name: "Marina Teixeira", started: 4, completed: 2, hours: "21h", certs: 2, color: "#c0573a" },
  { initials: "BA", name: "Bruno Alves", started: 7, completed: 6, hours: "52h", certs: 6, color: "#2f9b8e" },
  { initials: "SN", name: "Sofia Nunes", started: 3, completed: 3, hours: "24h", certs: 3, color: "#9b2f7a" },
];

export const MOCK_REPORT_COURSES = [
  { tag: "ST", name: "Segurança no Trabalho", students: "312", progress: 94, color: "#CC1F1F" },
  { tag: "LI", name: "Lubrificação Industrial", students: "268", progress: 88, color: "#3a6ea5" },
  { tag: "AC", name: "Atendimento ao Cliente", students: "241", progress: 82, color: "#1f8a5b" },
  { tag: "LT", name: "Liderança de Times", students: "197", progress: 64, color: "#b9842f" },
  { tag: "CL", name: "Compliance e LGPD", students: "154", progress: 69, color: "#7a4fb9" },
];
